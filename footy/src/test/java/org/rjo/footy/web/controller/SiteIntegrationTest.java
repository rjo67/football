...
public class SiteIntegrationTest {
	...
	public void setup() {
		...
		gd.add(new GameDetails("2014-02-10", "Lieth"));
		gd.add(new GameDetails("2014-04-06", "Holm"));
		AllGamesEvent allGamesEvent = new AllGamesEvent(gd);
		when(gameService.requestAllGames(any(RequestAllGamesEvent.class)))
				.thenReturn(allGamesEvent);
